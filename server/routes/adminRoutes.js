...
import { getTraMC, getTaxMC, getGuiMC, getServMC } from "../controllers/adminController.js";
...
router.get("/utaxM", getTaxMC);
router.get("/uguiM", getGuiMC);
router.get("/uservM", getServMC);
